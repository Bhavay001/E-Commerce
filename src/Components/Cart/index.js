...
import Modal from '../Products/UI/Modal'
import OrderSuccessModal from '../Products/UI/OrderSuccess'
...
const Cart = ({count,items,onHandleEvent}) =>{
    ...
    const handleModal  =() =>{
        setShowModal(previosState => !previosState)
    }
    const handleOrderModal = () =>{
        setShowModal(false)
        setOrderModal(previos => !previos )
    }
    return(
    <>
